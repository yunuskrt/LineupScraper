...
def download_links_from_index():
    ...
    important_teams = {
        2023: ['Bayern Munich', 'Bor. Dortmund', 'B. Leverkusen'],
        2022: ['Bayern Munich', 'Bor. Dortmund'],
        2021: ['Bayern Munich', 'Bor. Dortmund'],
        2020: ['Bayern Munich', 'Bor. Dortmund'],
        2019: ['Bayern Munich', 'Bor. Dortmund'],
        2018: ['Bayern Munich', 'Bor. Dortmund'],
        2017: ['Bayern Munich', 'Bor. Dortmund'],
        2016: ['Bayern Munich', 'Bor. Dortmund'],
        2015: ['Bayern Munich', 'Bor. Dortmund'],
        2014: ['Bayern Munich'],
        2013: ['Bayern Munich', 'Bor. Dortmund'],
        2012: ['Bayern Munich', 'Bor. Dortmund'],
        2011: ['Bayern Munich', 'Bor. Dortmund'],
        2010: ['Bayern Munich', 'Bor. Dortmund'],
    }
    relevant_teams = ['Bayern Munich', 'Bor. Dortmund', 'B. Leverkusen','RB Leipzig','VfL Wolfsburg','VfB Stuttgart','Werder Bremen']

    for saison in range(2015,2009,-1):
        season = '{}/{}'.format(saison,saison+1)
        url = baseURL + "/bundesliga/gesamtspielplan/wettbewerb/L1?saison_id={}".format(saison)
        ...
        for containerBox in containerBoxes:
            ...
            for matchBox in matchBoxes:
                ...
                for match_row in match_rows:
                    ...
                    if (home_team in important_teams[saison] and away_team in relevant_teams) or (away_team in important_teams[saison] and home_team in relevant_teams):
                        match_link = match_row.find('td',{'class':'zentriert hauptlink'}).find('a',{'class':'ergebnis-link'})['href']
                        # print(home_team,'-',away_team,'--->',baseURL+match_link)
                        print('Writing',home_team,'-',away_team)
