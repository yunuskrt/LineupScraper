...
def download_links_from_index():
    ...
    important_teams = ['Fenerbahce', 'Galatasaray', 'Besiktas']

    saison = 2007
    season = '{}/{}'.format(saison,saison+1)
    

    url = baseURL + "/super-lig/gesamtspielplan/wettbewerb/TR1?saison_id={}".format(saison)
    ...
    for containerBox in containerBoxes:
        ...
        for matchBox in matchBoxes:
            ...
            for match_row in match_rows:
                ...
                if saison <= 2010:
                    big_teams = ['Fenerbahce', 'Galatasaray', 'Besiktas', 'Trabzonspor']
                    # check if both teams are big teams
                    if home_team in big_teams and away_team in big_teams:
                        ...
                        print('Writing',home_team,'-',away_team, '--->',baseURL+match_link)
