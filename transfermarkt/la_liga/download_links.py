...
def download_links_from_index():
    ...
    important_teams = ['Real Madrid','Barcelona','Atlético Madrid']
    relevant_teams = ['Real Madrid','Barcelona','Atlético Madrid','Villarreal','Real Sociedad','Valencia','Sevilla FC']

    for saison in range(2023,2006,-1):
        season = '{}/{}'.format(saison,saison+1)
        url = baseURL + "/laliga/gesamtspielplan/wettbewerb/ES1?saison_id={}".format(saison)
